        ...
        <div class="w65"> 
            ...
            {if isset($affBoutonsAdmin)}
                {if $annonce.A_etat!=='bloquée'}
                    <a class="a-none" href="/annonce/changerEtat/{$annonce.A_idannonce}/bloquée/annoncesUti/"><button class="btn--danger"><i class="fas fa-ban"></i> Bloquer l'annonce</button></a>
                {else}
                    <a class="btn--success a-none" href="/annonce/changerEtat/{$annonce.A_idannonce}/en cours/annoncesUti/" ><i class="fas fa-check-double"></i> Débloquer l'annonce</a>
                {/if}
